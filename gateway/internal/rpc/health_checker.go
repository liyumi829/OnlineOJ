...
func NewPingHealthChecker(nodes []*JudgeNode, timeout, interval time.Duration) *PingHealthChecker {
...
// checkOne 检查单个节点
func (h *PingHealthChecker) checkOne(ctx context.Context, node *JudgeNode) {
